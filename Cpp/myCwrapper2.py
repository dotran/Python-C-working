...
class Greeting(object):
    def __init__(self, n): # set input param n here is just for testing, not preferable
        self.obj = _libmyCfuncs.myClassObj()
        self._as_parameter_ = n # set input param n here is just for testing, not preferable
    
    def callGreeting(self): # set input param n here will be more preferable
        _libmyCfuncs.myGreeting(self.obj, self._as_parameter_)
